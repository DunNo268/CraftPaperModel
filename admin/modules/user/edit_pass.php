...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	<div class="row">
		<ol class="breadcrumb">
			...
			<li><a style="text-decoration: none; color: #606468;" href="">Quản lý tài khoản</a></li>
				...
				<div class="panel-body">
					...
					<form role="form" method="post">
						...
						<div class="form-group">
							...
							<input disabled name="user_phone" required class="form-control" value="<?php echo $userEdit['user_phone']; ?>" placeholder="">
						</div>
						<div class="form-group">
							<label>Email</label>
