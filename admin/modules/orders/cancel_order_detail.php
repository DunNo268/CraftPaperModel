<?php
    if(isset($_GET['order_id'])) {
        ...
        header('location: index.php?page=cancel_order');
    }
?>
                        ...
                        <table  data-toolbar="#toolbar"data-toggle="table">
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="reason" data-sortable="true">Lý do huỷ đơn</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php  
                                ...
                                if (mysqli_num_rows($resultOrder_detail)) {
                                    while ($row = mysqli_fetch_assoc($resultOrder_detail)) {
                                        if (!$customerPrinted) {
                                            echo '<ul>';
                                            echo 'Tên khách hàng: ' . $row['customer_name'] . '<br><b>Người duyệt đơn: </b>' . $row['user_full'];
                                            echo '</ul>';
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style=""><?php echo $row['reason']; ?></td>
                                    </tr>
                                <?php         
                                    }
                                } 
