<?php 
    ...
    $sql_order = "SELECT * FROM orders WHERE status_id = '3' ";
    ...
    $sql_pagination = "SELECT * FROM orders WHERE status_id = '3' ORDER BY order_id DESC LIMIT $start,$rowPerPage";
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active"><a style="text-decoration: none; color: #606468;" href="index.php?page=order">Quản lý đơn hàng</li></a>
		</ol>
	</div><!--/.row-->
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Đơn đã xử lý</h1>
		</div>
	</div><!--/.row-->
