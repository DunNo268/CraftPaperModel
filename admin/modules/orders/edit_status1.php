<?php 
    ...
    //Lấy thông tin mới
        if(isset($_POST['sbm'])) {
            ...
            $sql_update2 = "UPDATE storage SET amount = amount - ( SELECT kits FROM orders WHERE order_id = $order_id) WHERE storage_id = 1 ;";
            $sql_update3 = "UPDATE orders SET user_id = $user_id WHERE order_id = $order_id ;";
            if(mysqli_query($conn, $sql_update1) AND mysqli_query($conn, $sql_update2) AND mysqli_query($conn, $sql_update3)) {
                ...
                if($status_id == 1){
                    $str_body .= ' 
                        <p>
                            ...
                            <b style="color: black;">Trạng thái đơn hàng: Đang xử lý</b><br>
                        </p>'
                    ;
                }else if($status_id == 2){
                    $str_body .= ' 
                ...
                header("location: /CraftPaperModel2/admin/index.php?page=order_unprocessed");
            }else{
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status_id" required class="form-control">
                                <option value = '0' <?php echo ($OrderEdit['status_id'] == '0') ? 'selected' : ''; ?>>Chưa xử lý</option>
