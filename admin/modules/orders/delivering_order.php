<?php 
    ...
    $sql_order = "SELECT * FROM orders WHERE status_id = '2';";
    ...
    $sql_pagination = "SELECT * FROM orders WHERE status_id = '2' ORDER BY order_id ASC LIMIT $start,$rowPerPage";
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Đơn đang giao hàng</h1>
		</div>
	</div><!--/.row-->
                        ...
                        <tbody>
                            ...
                            ?> 
                                <tr>
                                    ...
                                    <td><span class="label label-success">Đang giao hàng</span></td>
                                    <td class="form-group">
...
<script>
    ...
    function confirmUpd() {
        return confirm("Bạn có chắc chắn muốn chuyển đơn này sang trạng thái đã xử lý?");
    }
</script>