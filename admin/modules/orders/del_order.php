...
<?php 
    ...
    $sqlOrder = "SELECT orders.customer_name, orders.customer_phone, orders.customer_email, orders.customer_address, orders.status_id, pay_name FROM orders
    ...
    //Lấy thông tin mới
        if(isset($_POST['sbm'])) {
            ...
            if(mysqli_query($conn, $sqlUpdate)) {
                //Send mail
                $sqlOrderr = "SELECT * FROM orders WHERE order_id = $order_id ;";
                $resultOrderr = mysqli_query($conn, $sqlOrderr);
                while ($row = mysqli_fetch_assoc($resultOrderr)) {
                ...
                $str_body .= '<p><h3 style="text-align: center; color: black;">THÔNG BÁO HUỶ ĐƠN HÀNG</h3></p>';
                $str_body .= ' 
                    <p>
                        ...
                        <b style="color: black;">Trạng thái đơn hàng: Đã bị huỷ</b><br>
                        <b style="color: black;">Lý do huỷ: ' . $reason . '</b><br>
                    </p>'
                ;          
                $str_body .= '
                ...
                try {
                    ...
                    $mail->isHTML(true);
                    $mail->Subject = 'Thông báo huỷ đơn hàng';
                    $mail->Body = $str_body;
                    $resul = $mail->send();
                    if (!$resul) {
                ...
                header("location: index.php?page=order_unprocessed");
            }else{
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li><a style="text-decoration: none; color: #606468;" href="index.php?page=order">Quản lý đơn hàng</a></li>
                ...
                <div class="panel-body">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input disabled name="status_id" required class="form-control" value="Đã huỷ đơn" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="reason">Lý do huỷ đơn hàng</label><br>
                            <input type="text" name="reason" required class="form-control" placeholder="">
                        </div> 
