            ...
            <div class="panel panel-default">
                    <div class="panel-body">
                        <table  data-toolbar="#toolbar"data-toggle="table">
                            ...
                            <?php if (checkPrivilege('index.php?page=edit_status1&order_id='.$order_id)) { ?>
                                <a title="Sửa trạng thái đơn hàng" href="index.php?page=edit_status1&order_id=<?php echo $order_id; ?>" class="btn btn-warning">
                                    <i class="glyphicon glyphicon-pencil"></i>
                                </a>
                            <?php } ?> &nbsp;
                            <a title="Huỷ đơn" onclick="return confirmDel();" href="index.php?page=del_order&order_id=<?php echo $order_id; ?>" class="btn btn-danger">
