<?php 
    ...
    $sql_pagination = "SELECT * FROM category WHERE status = 1 ORDER BY category_id DESC LIMIT $start,$rowPerPage";
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
    ...
    <?php if (checkPrivilege('index.php?page=add_category')) { ?>
        <div id="toolbar" class="btn-group">      
            <a style="border-radius: 6px;" href="index.php?page=add_category" class="btn btn-success">
                <i class="glyphicon glyphicon-plus"></i> Thêm danh mục
            </a>
            <div class="search-container" style="float:left; margin-left: 10px;">
                <form action="index.php?page=search_category" method="POST">
                    <input type="text" name="keyword" id="keyword" placeholder="Tìm kiếm danh mục">
                    <button type="submit" name="search_category" onclick="return validateSearch();"><i class="fa fa-search"></i></button>
