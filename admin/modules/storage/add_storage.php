<?php 
    ...
    if(isset($_GET['storage_id'])) {
        ...
        if(isset($_POST['sbm'])) {
            ...
            $sqlUpdate = "UPDATE storage SET amount = amount + '$plus' WHERE storage_id = $storage_id";
                ...
                <div class="panel-body">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input disabled type="text" name="amount" required class="form-control" value="<?php echo $storageEdit['amount']; ?>" placeholder="">
                        </div>
                        <div class="form-group">
                            <label>Nhập thêm vào kho</label>
                            <input type="number" min="0" name="plus" required class="form-control" placeholder="">
                        </div>             
