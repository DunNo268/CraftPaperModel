<div style="width: 100%; display: flex;">
    <div style="width: 80%; margin: auto; text-align: left;">
        <div style="width: 50%; float: left; text-align: left;">
            <h2 style="font-size: 30px; color: #35417A;">Sản phẩm hot</h2>
        </div>
        <div style="width: 50%; float: left; text-align: right;">
            <a style="text-decoration: none; color: puprle;;" href="index.php?page_layout=product_featured">
...
<?php
    $sql_product = "SELECT * FROM product WHERE status = 1 AND prd_featured = 1 ORDER BY prd_id ASC LIMIT 3";
