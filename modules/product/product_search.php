<?php
    if(isset($_POST['product_search'])){          
        ...
        $sql_product = "SELECT * FROM product WHERE status = 1 AND prd_name LIKE '%$keyword%'";
        ...
        $sql_pagination = "SELECT * FROM product WHERE status = 1 AND prd_name LIKE '%$keyword%' ORDER BY prd_id DESC LIMIT $start,$rowPerPage";
...
<div style="width: 100%; display: flex;">
    <div style="width: 50%; margin: auto; text-align: center;">
        <br><br><h4>-------- Bạn đang tìm kiếm Sản phẩm có tên "<?php echo $_POST['keyword']; ?>" --------</h4><br><br>
    </div>
</div>
<div style="width: 100%; display: flex;">
