<?php 
    if(isset($_GET['category_id'])) {
        ...
        $sql_product = "SELECT * FROM product WHERE status = 1 AND category_id = $category_id";
        ...
        $sql_pagination = "SELECT * FROM product WHERE status = 1 AND category_id = $category_id ORDER BY prd_id DESC LIMIT $start,$rowPerPage";
...
<div style="width: 100%; display: flex;">
    <div style="width: 50%; margin: auto; text-align: center;">
        <?php
            ...
            $rowCat = mysqli_fetch_array($queryCat)                                    
        ?> 
        <br><br><h4>-------- Bạn đang ở trang <?php echo $rowCat['category_name']; ?> --------</h4><br><br>
    </div>
</div>
<div style="width: 100%; display: flex;">
    <div style="width: 80%; margin: auto; text-align: justify;">
        <a style="text-decoration: none; color: #35417A;" href="#"><strong><?php echo $rowCat['category_name']; ?></strong></a> - DunNo Kit cung cấp các <em><strong>bộ mô hình giấy</strong></em> thủ công được in theo tiêu chuẩn chất lượng tốt nhất. Thông qua các bộ mô hình được cập nhật liên tục, quý khách có thể nắm bắt, sưu tập thêm được nhiều mô hình thú vị.<br><br><hr><br><br>
    </div>
</div>
<div style="width: 100%; display: flex;">
    <div style="width: 80%; margin: auto; text-align: center;">
        ...
        <div class="pagination"> 
            ...
            <?php if($current_page > 1) { ?>
                <a href="index.php?page_layout=product_category&category_id=<?php echo $rowCat['category_id']; ?>&current_page=<?php echo $current_page-1; ?>">&laquo;</a>
            <?php }else { ?>
            ...
            <?php for($i = 1; $i <= $totalPage; $i++) { 
                if($i > $current_page - 3 && $i < $current_page + 3) { 
                    if($i == $current_page) {   
            ?>
                <a class="active" href="index.php?page_layout=product_category&category_id=<?php echo $rowCat['category_id']; ?>&current_page=<?php echo $i; ?>"><?php echo $i; ?></a>
                <?php }else { ?>
                <a href="index.php?page_layout=product_category&category_id=<?php echo $rowCat['category_id']; ?>&current_page=<?php echo $i; ?>"><?php echo $i; ?></a>
            <?php 
                    }
                }
            }
            ...
            <?php if($current_page < $totalPage) { ?>
                <a href="index.php?page_layout=product_category&category_id=<?php echo $rowCat['category_id']; ?>&current_page=<?php echo $current_page + 1; ?>">&raquo;</a>
            <?php }else {?>
